...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'enlightn.allowed_permissions./var/www/html' => 'string',
            'enlightn.allowed_permissions./var/www/html/app' => 'string',
            'enlightn.allowed_permissions./var/www/html/resources' => 'string',
            'enlightn.allowed_permissions./var/www/html/storage' => 'string',
            'enlightn.allowed_permissions./var/www/html/public' => 'string',
            'enlightn.allowed_permissions./var/www/html/config' => 'string',
            'enlightn.allowed_permissions./var/www/html/database' => 'string',
            'enlightn.allowed_permissions./var/www/html/routes' => 'string',
            'enlightn.allowed_permissions./var/www/html/bootstrap' => 'string',
            'enlightn.allowed_permissions./var/www/html/bootstrap/cache' => 'string',
            'enlightn.allowed_permissions./var/www/html/bootstrap/app.php' => 'string',
            'enlightn.allowed_permissions./var/www/html/artisan' => 'string',
            'enlightn.allowed_permissions./var/www/html/public/index.php' => 'string',
            'enlightn.allowed_permissions./var/www/html/public/server.php' => 'string',
            ...
            'insights.config.SlevomatCodingStandard\Sniffs\Classes\ClassLengthSniff.maxLinesLength' => 'integer',
            ...
            'schedule-monitor.oh_dear.endpoint_url' => 'NULL',
            'schedule-monitor.oh_dear.api_url' => 'string',
...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','csp.policy','csp.report_only_policy',
'csp.report_uri','csp.enabled','csp.nonce_generator','csp.nonce_enabled','database.default',
...
'database.redis.horizon.backoff_base','database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','enlightn.analyzers','enlightn.exclude_analyzers',
'enlightn.ci_mode_exclude_analyzers','enlightn.analyzer_paths.Enlightn\\Enlightn\\Analyzers','enlightn.analyzer_paths.Enlightn\\EnlightnPro\\Analyzers','enlightn.base_path','enlightn.skip_env_specific',
'enlightn.guest_url','enlightn.dont_report','enlightn.ignore_errors','enlightn.license_whitelist','enlightn.credentials.username',
'enlightn.credentials.api_token','enlightn.github_repo','enlightn.compact_lines','enlightn.commercial_packages','enlightn.allowed_permissions./var/www/html',
'enlightn.allowed_permissions./var/www/html/app','enlightn.allowed_permissions./var/www/html/resources','enlightn.allowed_permissions./var/www/html/storage','enlightn.allowed_permissions./var/www/html/public','enlightn.allowed_permissions./var/www/html/config',
'enlightn.allowed_permissions./var/www/html/database','enlightn.allowed_permissions./var/www/html/routes','enlightn.allowed_permissions./var/www/html/bootstrap','enlightn.allowed_permissions./var/www/html/bootstrap/cache','enlightn.allowed_permissions./var/www/html/bootstrap/app.php',
'enlightn.allowed_permissions./var/www/html/artisan','enlightn.allowed_permissions./var/www/html/public/index.php','enlightn.allowed_permissions./var/www/html/public/server.php','enlightn.writable_directories','enlightn.phpstan.--error-format',
'enlightn.phpstan.--no-progress','enlightn.phpstan.--memory-limit','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'health.schedule.heartbeat_url','health.theme','health.silence_health_queue_job','health.json_results_failure_status','health.secret_token',
...
'horizon.environments.production.supervisor-1.maxProcesses','horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','insights.preset',
'insights.ide','insights.exclude','insights.add','insights.remove','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Files\\LineLengthSniff.lineLimit',
'insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Files\\LineLengthSniff.absoluteLineLimit','insights.config.SlevomatCodingStandard\\Sniffs\\Functions\\FunctionLengthSniff.maxLinesLength','insights.config.SlevomatCodingStandard\\Sniffs\\Classes\\ClassLengthSniff.maxLinesLength','insights.requirements.min-quality','insights.requirements.min-complexity',
'insights.requirements.min-architecture','insights.requirements.min-style','insights.requirements.disable-security-check','insights.threads','logging.default',
...
'logging.channels.nightwatch.level','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','schedule-monitor.delete_log_items_older_than_days','schedule-monitor.date_format',
...
'schedule-monitor.oh_dear.retry_job_for_minutes','schedule-monitor.oh_dear.silence_ping_oh_dear_job_in_horizon','schedule-monitor.oh_dear.send_starting_ping','schedule-monitor.oh_dear.grace_time_in_minutes','schedule-monitor.oh_dear.endpoint_url',
'schedule-monitor.oh_dear.api_url','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','storage.local',);
        registerArgumentsSet('views', 
'welcome','health::list','health::list-cli','health::logo','health::mail.checkFailedNotification',
'health::status-indicator','horizon::layout','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'pagination::simple-tailwind','pagination::tailwind','schedule-monitor::alert','schedule-monitor::components.duplicate-tasks','schedule-monitor::components.monitored-tasks',
'schedule-monitor::components.ready-for-monitoring-tasks','schedule-monitor::components.task','schedule-monitor::components.title','schedule-monitor::components.unnamed-tasks','schedule-monitor::list',
'schedule-monitor::sync','telescope::layout',);
...
'validation.custom.attribute-name.rule-name','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.check_failed_slack_message',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ar.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.check_failed_mail_body',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bg.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.check_failed_mail_subject',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.bn.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.laravel_health',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.cz.notifications.check_results_from',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.health_results',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.da.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.check_failed_slack_message',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.de.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.check_failed_mail_body',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.en.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.check_failed_mail_subject',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.es.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.laravel_health',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fa.notifications.check_results_from',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.health_results',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.fr.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.check_failed_slack_message',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.hi.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.check_failed_mail_body',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.it.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.check_failed_mail_subject',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.lv.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.laravel_health',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.nl.notifications.check_results_from',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.health_results',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.check_failed_slack_message',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.pt_BR.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.check_failed_mail_body',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.ru.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.laravel_health','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.check_failed_mail_subject',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.sk.notifications.check_results_from','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.laravel_health',
'health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.check_failed_mail_subject','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.check_failed_mail_body','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.check_failed_slack_message','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.health_results','health::.var.www.html.vendor.spatie.laravel-health.resources.lang.tr.notifications.check_results_from',);
        registerArgumentsSet('env', 
'APP_ENV','APP_DEBUG','LOG_LEVEL','LOG_CHANNEL','TELESCOPE_ENABLED',
'SESSION_SECURE_COOKIE','APP_NAME','APP_KEY','APP_URL','APP_TIMEZONE',
'COMPOSE_PROJECT_NAME','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','DB_ROOT_PASSWORD','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','QUEUE_CONNECTION',
'CACHE_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','LOG_STACK','NIGHTWATCH_TOKEN',
'NIGHTWATCH_EXCEPTION_SAMPLE_RATE','NIGHTWATCH_COMMAND_SAMPLE_RATE','NIGHTWATCH_REQUEST_SAMPLE_RATE','HORIZON_PREFIX','HORIZON_DASHBOARD_ENABLED',
'SESSION_HTTP_ONLY','SESSION_SAME_SITE','SSL_COMMON_NAME','WATCHTOWER_NOTIFICATIONS','WATCHTOWER_DEBUG',
'SNYK_TOKEN','SNYK_SEVERITY_THRESHOLD','SNYK_FAIL_ON_ISSUES','SNYK_MONITOR_ENABLED','VITE_APP_NAME',);
