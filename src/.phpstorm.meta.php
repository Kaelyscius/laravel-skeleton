...
'cors.max_age','cors.supports_credentials','concurrency.default','nightwatch.enabled','nightwatch.token',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope',
'storage.local',);
