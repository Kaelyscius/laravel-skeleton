...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'health.notifications.only_on_failure' => 'boolean',
...
'filesystems.links./var/www/html/public/storage','health.result_stores.Spatie\\Health\\ResultStores\\EloquentHealthResultStore.connection','health.result_stores.Spatie\\Health\\ResultStores\\EloquentHealthResultStore.model','health.result_stores.Spatie\\Health\\ResultStores\\EloquentHealthResultStore.keep_history_for_days','health.notifications.enabled',
'health.notifications.notifications.Spatie\\Health\\Notifications\\CheckFailedNotification','health.notifications.notifiable','health.notifications.throttle_notifications_for_minutes','health.notifications.throttle_notifications_key','health.notifications.only_on_failure',
...
'health.json_results_failure_status','health.secret_token','horizon.name','horizon.domain','horizon.path',
...
'horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','insights.preset','insights.ide','insights.exclude',
'insights.add','insights.remove','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Files\\LineLengthSniff.lineLimit','insights.config.PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Files\\LineLengthSniff.absoluteLineLimit','insights.config.SlevomatCodingStandard\\Sniffs\\Functions\\FunctionLengthSniff.maxLinesLength',
'insights.config.SlevomatCodingStandard\\Sniffs\\Classes\\ClassLengthSniff.maxLinesLength','insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture','insights.requirements.min-style',
'insights.requirements.disable-security-check','insights.threads','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.markdown.paths','mail.markdown.extensions','pulse.domain','pulse.path','pulse.enabled',
...
'schedule-monitor.oh_dear.endpoint_url','schedule-monitor.oh_dear.api_url','services.postmark.key','services.resend.key','services.ses.key',
...
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','mcp.redirect_domains','nightwatch.enabled',
...
'nightwatch.ingest.event_buffer','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages','livewire.component_layout',
...
'livewire.upload-file','livewire.preview-file','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'pulse::dashboard','vendor.pulse.dashboard','welcome','7224ff0b1fa42156c352216deff15b56::card','7224ff0b1fa42156c352216deff15b56::card-header',
...
'7224ff0b1fa42156c352216deff15b56::th','7224ff0b1fa42156c352216deff15b56::thead','7224ff0b1fa42156c352216deff15b56::theme-switcher','7224ff0b1fa42156c352216deff15b56::user-card','health::list',
'health::list-cli','health::logo','health::mail.checkFailedNotification','health::status-indicator','horizon::layout',
...
'pulse::livewire.usage','schedule-monitor::alert','schedule-monitor::components.duplicate-tasks','schedule-monitor::components.monitored-tasks','schedule-monitor::components.ready-for-monitoring-tasks',
'schedule-monitor::components.task','schedule-monitor::components.title','schedule-monitor::components.unnamed-tasks','schedule-monitor::list','schedule-monitor::sync',
'telescope::layout',);
