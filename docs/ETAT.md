...
**Non touchés, et c'est délibéré** — `docker/apache/conf/sites-enabled/laravel.conf.template` (renommé par la story 2.5 ; le bloc `<Location /health>` y est désormais vers la fin du fichier) (Ask
